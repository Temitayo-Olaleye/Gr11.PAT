...
Library’s Admin password: ‘Go@tinelli#’

This program is for the use of the library staff. The only time a customer should be allowed to enter information would be when they’re inputting their information and passwords, otherwise, the customer must communicate verbally with the employee. This is done to keep customer information safe.

On running this program you are greeted with the login form. Here, the employee/admin is required to enter the Library’s Admin password: ‘Go@tinelli#’. 
...
btnDisplayCustomerInfo displays the customer’s textfile in a richedit.
...
The customer’s information is now changed, IsBookOut field is now true, meaning that they can’t take out another book until this one is returned. Additionally, the book information is edited. The AvailabilityStatus field now becomes false. Meaning, this bookID can’t be used in another transaction until the book is returned. A textfile containing the details of the transaction is also made.
